...
//
// Acrescente à biblioteca UThread a primitiva DWORD UtSleep(DWORD sleepTimeInMilis), 
// que promove o bloqueio da thread invocante durante, pelo menos, o número de milissegundos 
// indicado. A função devolve o tempo efectivo de espera, também em milissegundos. Para a medição 
// de tempos, utilize a função da Windows API GetTickCount.
//
UTHREAD_API
